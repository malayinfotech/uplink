...
func encryptionParameters(project *Project) storx.EncryptionParameters {
...
func deriveContentKey(project *Project, bucket, key string) (*storx.Key, error) {
	encStore := project.access.encAccess.Store
...
func ecPutSingleResult(ctx context.Context, project *Project, limits []*pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey,
