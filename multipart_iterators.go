...
func decryptETag(project *Project, bucket, key string, encryptionParameters storx.EncryptionParameters, segment metaclient.SegmentListItem) ([]byte, error) {
	...
	return encryption.Decrypt(segment.EncryptedETag, encryptionParameters.CipherSuite, etagKey, &storx.Nonce{})
}
