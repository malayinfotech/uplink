...
func runTest(t *testing.T, test func(*testing.T, context.Context, *testplanet.Planet, *metaclient.DB, *streams.Store)) {
	runTestWithPathCipher(t, 4, storx.EncAESGCM, test)
}

func runTestWithoutSN(t *testing.T, test func(*testing.T, context.Context, *testplanet.Planet, *metaclient.DB, *streams.Store)) {
	runTestWithPathCipher(t, 0, storx.EncAESGCM, test)
}

func runTestWithPathCipher(t *testing.T, storageNodeCount int, pathCipher storx.CipherSuite, test func(*testing.T, context.Context, *testplanet.Planet, *metaclient.DB, *streams.Store)) {
