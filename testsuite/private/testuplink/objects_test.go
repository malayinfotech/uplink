...
func TestListObjects(t *testing.T) {
	runTestWithPathCipher(t, 0, storx.EncNull, func(t *testing.T, ctx context.Context, planet *testplanet.Planet, db *metaclient.DB, streams *streams.Store) {
		bucket, err := db.CreateBucket(ctx, TestBucket)
		require.NoError(t, err)
...
func TestListObjects_PagingWithDiffPassphrase(t *testing.T) {
	runTestWithPathCipher(t, 0, storx.EncAESGCM, func(t *testing.T, ctx context.Context, planet *testplanet.Planet, dbA *metaclient.DB, streams *streams.Store) {
