...
/*
Package uplink is the main entrypoint to interacting with Storx Labs' decentralized
storage network.

Sign up for an account on a Satellite today! https://storx.io/

# Access Grants

The fundamental unit of access in the Storx Labs storage network is the Access Grant.
An access grant is a serialized structure that is internally comprised of an API Key,
a set of encryption key information, and information about which Storx Labs or
...
https://storx.io/ and note the Satellite you choose (such as
us1.storx.io, eu1.storx.io, etc). Then, make an API Key in the web interface.
