...
// NewRedundancyStrategyFromStorx creates new RedundancyStrategy from the given
// storx.RedundancyScheme.
func NewRedundancyStrategyFromStorx(scheme storx.RedundancyScheme) (RedundancyStrategy, error) {
