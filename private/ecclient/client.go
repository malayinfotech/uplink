...
type Client interface {
	PutSingleResult(ctx context.Context, limits []*pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, rs eestream.RedundancyStrategy, data io.Reader) (results []*pb.SegmentPieceUploadResult, err error)
	Get(ctx context.Context, limits []*pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, es eestream.ErasureScheme, size int64) (ranger.Ranger, error)
	...
	PutPiece(ctx, parent context.Context, limit *pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, data io.ReadCloser) (hash *pb.PieceHash, id *struct{}, err error)
}

type dialPiecestoreFunc func(context.Context, storx.NodeURL) (*piecestore.Client, error)
...
func (ec *ecClient) dialPiecestore(ctx context.Context, n storx.NodeURL) (*piecestore.Client, error) {
...
func (ec *ecClient) PutSingleResult(ctx context.Context, limits []*pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, rs eestream.RedundancyStrategy, data io.Reader) (results []*pb.SegmentPieceUploadResult, err error) {
...
func (ec *ecClient) put(ctx context.Context, limits []*pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, rs eestream.RedundancyStrategy, data io.Reader, expiration time.Time) (successfulNodes []*pb.Node, successfulHashes []*pb.PieceHash, err error) {
	defer mon.Task()(&ctx,
...
func (ec *ecClient) PutPiece(ctx, parent context.Context, limit *pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, data io.ReadCloser) (hash *pb.PieceHash, deprecated *struct{}, err error) {
	nodeName := "nil"
	if limit != nil {
...
func (ec *ecClient) Get(ctx context.Context, limits []*pb.AddressedOrderLimit, privateKey storx.PiecePrivateKey, es eestream.ErasureScheme, size int64) (rr ranger.Ranger, err error) {
...
func limitToNodeURL(limit *pb.AddressedOrderLimit) storx.NodeURL {
	return (&pb.Node{
