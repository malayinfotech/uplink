...
func NewUploadPart(ctx context.Context, bucket, key string, streamID storx.StreamID, partNumber uint32, eTagCh <-chan []byte, streamsStore *streams.Store) *PartUpload {
