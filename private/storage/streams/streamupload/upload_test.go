...
var (
	...
	encMetadataKey      = storx.EncryptedPrivateKey("METADATA-KEY")
	encMetadataKeyNonce = storx.Nonce{0: 0, 1: 1, 2: 2, 3: 3}
...
func (encryptedMetadata) EncryptedMetadata(lastSegmentSize int64) (data []byte, encKey *storx.EncryptedPrivateKey, nonce *storx.Nonce, err error) {
	return encryptMetadata(lastSegmentSize), &encMetadataKey, &encMetadataKeyNonce, nil
}

func mustNewStreamID() storx.StreamID {
	...
	return storx.StreamID(streamID)
}
