...
func (failExchange) ExchangeLimits(ctx context.Context, segmentID storx.SegmentID, pieceNumbers []int) (storx.SegmentID, []*pb.AddressedOrderLimit, error) {
...
func (f fakeExchanger) ExchangeLimits(ctx context.Context, segmentID storx.SegmentID, pieceNumbers []int) (storx.SegmentID, []*pb.AddressedOrderLimit, error) {
	if len(segmentID) != 1 {
...
func makeSegmentID(rev revision) storx.SegmentID {
	return storx.SegmentID{rev.value}
}
