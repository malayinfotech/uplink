...
func Dial(ctx context.Context, dialer rpc.Dialer, nodeURL storx.NodeURL, config Config) (*Client, error) {
...
func DialReplaySafe(ctx context.Context, dialer rpc.Dialer, nodeURL storx.NodeURL, config Config) (*Client, error) {
...
func (client *Client) NodeURL() storx.NodeURL { return client.nodeURL }
