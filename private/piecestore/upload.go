...
func (client *Client) UploadReader(ctx context.Context, limit *pb.OrderLimit, piecePrivateKey storx.PiecePrivateKey, data io.Reader) (hash *pb.PieceHash, err error) {
	...
	if !ok {
		...
		// https://review.dev.c/storx/storx/+/9686, we could
