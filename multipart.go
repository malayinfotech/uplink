...
func (project *Project) CommitUpload(ctx context.Context, bucket, key, uploadID string, opts *CommitUploadOptions) (object *Object, err error) {
	...
	id, err := storx.StreamIDFromBytes(decodedStreamID)
	if err != nil {
...
func (project *Project) fillMetadata(bucket, key string, id storx.StreamID, metadata CustomMetadata) (metaclient.CommitObjectParams, error) {
...
func (project *Project) ListUploads(ctx context.Context, bucket string, options *ListUploadsOptions) *UploadIterator {
	...
	opts := metaclient.ListOptions{
		...
		Status:    int32(pb.Object_UPLOADING), // TODO: define object status constants in storx package?
	}
